...
try {
  contractAddress = YHWHcoinConfig.contractAddress
  tronWeb = new TronWeb(
     YHWHcoinConfig.fullHost,
      YHWHcoinConfig.fullHost,
      YHWHcoinConfig.fullHost,
      YHWHcoinConfig.privateKey
  )
} catch (err) {
...
App = {
  ...
  init: async function () {
    ...
    this.accounts = [
      tronWeb.address.fromPrivateKey(YHWHcoinConfig.privateKey)
    ]
